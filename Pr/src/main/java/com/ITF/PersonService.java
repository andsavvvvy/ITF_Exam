...
public class PersonService {
    ...
    public static void updatePersonName(int id, String nume) {
    ...
    public static void updatePersonMail(int id, String email) {
    ...
    public static void insertPerson(Person Costumer) {
